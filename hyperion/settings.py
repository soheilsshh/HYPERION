...
SECRET_KEY = 'django-insecure-#h*cep#hf*s5pp&gm7b9mv2w(=34un^1)nh!sw%f#5=pk^qzom'
...
CELERY_BROKER_URL = 'redis://localhost:6300/1'
CELERY_BEAT_SCHEDULE = {
    'run-health-checks-every-minute': {
        'task': 'monitor.tasks.run_periodic_health_checks',
